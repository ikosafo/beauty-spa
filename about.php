                                ...
                                <div class="col-12">
                                    <div class="ttm-topbar-content">
                                        <ul class="top-contact text-start">
                                            ...
                                            <li><i class="fa fa-clock-o ttm-textcolor-skincolor"></i><a href="#">Mon-Sat: 9am to 6pm</a></li>
                                        </ul>
                                        <div class="topbar-right text-end">
                                            <div class="ttm-social-links-wrapper list-inline">
                                                <ul class="social-icons">
                                                    <li><a href="https://www.facebook.com/preyantechnosys19" class="tooltip-bottom" data-tooltip="Facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                    <li><a href="https://twitter.com/PreyanTechnosys" class="tooltip-bottom" data-tooltip="Twitter" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                                    <li><a href="https://www.linkedin.com/in/preyan-technosys-pvt-ltd/" class="tooltip-bottom" data-tooltip="Linkedin" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                                    <li><a href="https://www.instagram.com/preyan_technosys/" class="tooltip-bottom" data-tooltip="Instagram" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                                </ul>
                                            </div>
                                                ...
                                                <ul class="dropdown">
                                                    <li><a href="#">Home</a>
                                                        <ul>
                                                            ...
                                                            <li><a href="http://themetechmount.net/html/sylin/beauty">Demo Beauty</a></li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li><a href="#">services</a>
                                                        <ul>
                                                            <li><a href="skin-care.html">Skin Care Treatment</a></li>
                                                            <li><a href="ayurveda-therapies.html">Ayurveda Therapies</a></li>
                                                            <li><a href="back-massage.html">Back Massage</a></li>
                                                            <li><a href="body-massage.html">Body Massage</a></li>
                                                            <li><a href="hair-treatment.html">Hair Treatment</a></li>
                                                            <li><a href="scrubs-wraps.html">Scrubs & Wraps</a></li>
                                                        </ul>
                                                    </li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 res-767-center">
                            <img src="images/single-img-one.jpg" class="img-fluid" alt="about-image">
                        </div>
                        <div class="col-md-6 res-767-pt-30">
                            <div class="spacing-1">
                                <div class="section-title with-desc clearfix res-1199-mb-0">
                                    <div class="title-header">
                                        <h5 class="ttm-textcolor-skincolor">Wellness</h5>
                                        <h2 class="title">WELCOME TO SYLIN SPA</h2>
                                    </div>
                                    <div class="title-desc">There’s nothing more luxurious and relaxing than a trip to Sylin Spa. We offer a wide variety of body spa therapies to help you heal your body naturally. Get relaxed from a stressed & hectic schedule.</div>
                                </div>
                                <div class="row justify-content-space-between">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-3 col-6 featured-icon-box style1 text-center res-575-w-50">
                                        <div class="featured-icon">
                                            <div class="ttm-icon ttm-icon_element-size-lg">
                                                <i class="flaticon-person-silhouette-in-sauna ttm-textcolor-skincolor"></i>
                                            </div>
                                        </div>
                                        <div class="featured-content">
                                            <div class="featured-title">
                                ...
                                <p class="mt-40 res-1199-mt-20 res-1199-mb-0">Everybody is looking for places where to relax and get more energy. In our wellness center, silence, energy, beauty, and vitality meet. The treatments we offer will refresh both your body and soul. We’ll be glad to welcome you and recommend our facilities and services.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 widget-area">
                            <div class="widget widget_text clearfix">
                                ...
                                <div class="textwidget widget-text">
                                    <p class="pb-10 res-767-p-0">We consistently showed year on year growth and is now a chain of 118+ branches in Delhi NCR & Northern & Central India and worldwide</p>
                                    <p class="pb-10 res-767-p-0">The most innovative products tested & approved by the greatest names in hairdressing.</p>
                                    <a class="ttm-textcolor-skincolor" href="#" title="">- More About Hair Salone</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="d-flex flex-row align-items-center justify-content-end social-icons">
                                <ul class="social-icons list-inline">
                                    <li><a href="https://www.facebook.com/preyantechnosys19" class="tooltip-top" data-tooltip="Facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/PreyanTechnosys" class="tooltip-top" data-tooltip="Twitter" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.flickr.com/photos/166353669@N03/" class="tooltip-top" data-tooltip="Flickr" target="_blank"><i class="fa fa-flickr"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/preyan-technosys-pvt-ltd/" class="tooltip-top" data-tooltip="Linkedin" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
